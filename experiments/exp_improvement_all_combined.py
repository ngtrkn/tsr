#!/usr/bin/env python3
"""
Experiment: Improvement - All Combined
Phase 2: All Improvements Combined

Features:
- Hybrid Regression (spatial precision)
- HTML Refiner (structural refinement)
- GCAttention (global context)
...
def main():
    parser = argparse.ArgumentParser(description="All Improvements Combined Experiment")
    parser.add_argument(
        "--data_path",
        type=str,
        required=True,
    ...
    # Create experiment config with all improvements
    config = ExperimentConfig(
        ...
        use_hybrid_regression=True,  # All improvements enabled
