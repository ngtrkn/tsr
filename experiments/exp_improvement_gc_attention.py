#!/usr/bin/env python3
"""
Experiment: Improvement - Global Context Attention
Phase 2, Initiative C: Architectural Optimization

Features:
- Adds Global Context Attention (GCAttention)
...
def main():
    parser = argparse.ArgumentParser(description="GCAttention Improvement Experiment")
    parser.add_argument(
        "--data_path",
        type=str,
        required=True,
    ...
    config = ExperimentConfig(
        ...
        use_gc_attention=True,  # Enable GCAttention
