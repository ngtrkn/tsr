#!/usr/bin/env python3
"""
Experiment: Improvement - HTML Refiner
Phase 2, Initiative D: Structural Refinement
...
def main():
    parser = argparse.ArgumentParser(description="HTML Refiner Improvement Experiment")
    parser.add_argument(
        "--data_path",
        type=str,
        required=True,
    ...
    config = ExperimentConfig(
        ...
        use_html_refiner=True,  # Enable HTML refiner
